...
class _SignUpViewState extends State<SignUpView> {
  ...
  InputDecoration buildSignUpInputDecoration(String hint) {
    return InputDecoration(
      ...
      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Colors.blueAccent, width: 0.0)),
  ...
  List<Widget> buildButtons() {
    ...
    return [
      ...
      FlatButton(
        child: Text(_switchButtonText, style: TextStyle(color: Colors.blueAccent),),
        onPressed: () {
